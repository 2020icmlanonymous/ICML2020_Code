...
class FGSConv(Layer):
    ...
    def get_pooling_weight(self, input_shape,
        ...
        pooling_kernel = self.add_weight(shape=(1, input_shape * 2000),
    ...
    def get_activation_weight(self, input_shape,
                           ...
                           kernel_constraint=None):
        layer = self.__class__.__name__.lower()
        activation_kernel = self.add_weight(shape=(1, input_shape * 2000),
    ...
    def graph_conv_skip(self, x, channels, #name,
        ...
        # GSSL #
        alpha = 0.3 # good for texas power system with 10%, 20%, 70% and five features #
        alpha = 1.0 / alpha
